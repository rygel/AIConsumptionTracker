...
![Version](https://img.shields.io/badge/version-2.3.2--beta.18-orange)
...
### Manual
1. Download the latest `AIUsageTracker_Setup_v2.3.2-beta.18.exe` from the [Releases](https://github.com/rygel/AIUsageTracker/releases) page.
2. Run the installer.
